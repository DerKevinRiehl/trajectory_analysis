...
def evaluateModel(RELEVANT_MODEL, simple_name, dual):
...
internal_consistency.append(evaluateModel("Inference_cfa_r50_fpn_40e_dota_oc",                 "CFA", dual=True))
internal_consistency.append(evaluateModel("Inference_oriented_rcnn_r50_fpn_fp16_1x_dota_le90", "RCNN", dual=True))
internal_consistency.append(evaluateModel("Inference_redet_re50_refpn_1x_dota_ms_rr_le90",     "REDET", dual=True))
internal_consistency.append(evaluateModel("Inference_roi_trans_r50_fpn_1x_dota_ms_le90",       "ROI_TRANS", dual=True))
internal_consistency.append(evaluateModel("Inference_rotated_retinanet_obb_r50_fpn_1x_dota_ms_rr_le90", "RetinaNet", dual=True))
internal_consistency.append(evaluateModel("Inference_s2anet_r50_fpn_fp16_1x_dota_le135", "S2A", dual=True))
internal_consistency.append(evaluateModel("Inference_yolo_n_obb",                 "Yolo N", dual=True))
internal_consistency.append(evaluateModel("Inference_yolo_s_obb",                 "Yolo S", dual=True))
internal_consistency.append(evaluateModel("Inference_yolo_m_obb",                 "Yolo M", dual=True))
internal_consistency.append(evaluateModel("Inference_yolo_l_obb",                 "Yolo L", dual=True))
internal_consistency.append(evaluateModel("Inference_yolo_x_obb",                 "Yolo X", dual=True))
internal_consistency.append(evaluateModel("Inference_faster-rcnn_r50_fpn_hbb_DOTA", "RCNN", dual=False))
internal_consistency.append(evaluateModel("Inference_retinanet_r50_fpn_hbb_DOTA",   "RetinaNet", dual=False))
internal_consistency.append(evaluateModel("Inference_yolo_n_hbb",                 "Yolo N", dual=False))
internal_consistency.append(evaluateModel("Inference_yolo_s_hbb",                 "Yolo S", dual=False))
internal_consistency.append(evaluateModel("Inference_yolo_m_hbb",                 "Yolo M", dual=False))
internal_consistency.append(evaluateModel("Inference_yolo_l_hbb",                 "Yolo L", dual=False))
internal_consistency.append(evaluateModel("Inference_yolo_x_hbb",                 "Yolo X", dual=False))
