...
target_output_file = "../data_trajectories/6_final_trajectories_filtered/"+RELEVANT_VIDEO+".txt"
...
df, relax_1, relax_2 = reconstruct_trajectories_cvxopt(df, accel_max_spl, decel_min_spl)
plot_time_space_diagram(df)
plot_velocities_and_headways(df)
...
target_output_file = "../data_trajectories/7_final_trajectories_reconstructed/"+RELEVANT_VIDEO+"_cvxopt.txt"
...
for video in ALL_VIDEOS:
    target_output_file = "../data_trajectories/6_final_trajectories_filtered/"+video+".txt"
