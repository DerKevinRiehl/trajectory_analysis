...
axs[1].plot(speeds, accel_max, label="Vehicle Acceleration Capacity", color="blue", linestyle="--")
axs[1].plot(speeds, 0.5*accel_max, label="Common Driver Acceleration Capacity", color="blue")
