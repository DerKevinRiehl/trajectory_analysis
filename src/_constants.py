...
PROCESSING_MAX_VELOCITY = 8
PROCESSING_THR_VELOCITY = 0.7
PROCESSING_MIN_POSITION = -32
PROCESSING_MAX_POSITION = 32
PROCESSING_CARTESIAN_OUTLIER = 100
PROCESSING_CARTESIAN_THRESHOLD = 2.0
PROCESSING_MIN_HEADWAY_DIST = 6
