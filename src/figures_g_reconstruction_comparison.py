...
axs[0][0].plot(vehicle_df_CvxOpt["Global_Time"], vehicle_df_CvxOpt["v_Vel"], label="Proposed Reconstruction", linestyle="--", color=color_proposed)
...
axs[0][1].plot(vehicle_df_CvxOpt["Global_Time"], vehicle_df_CvxOpt["Space_Hdwy"], label="Proposed Reconstruction", linestyle="--", color=color_proposed)
...
axs[0][2].plot(vehicle_df_CvxOpt["Global_Time"], vehicle_df_CvxOpt["v_Accel"], label="Proposed Reconstruction", linestyle="--", color=color_proposed)
...
axs[1][0].plot(vehicle_df_CvxOpt["Global_Time"], vehicle_df_CvxOpt["Lane_X"]-vehicle_df_CvxOpt["Lane_X"].iloc[0], label="Proposed Reconstruction", linestyle="--", color=color_proposed)
...
axs[1][1].plot(vehicle_df_CvxOpt["Global_Time"], err_lanex_cvxopt, label="Proposed Reconstruction", linestyle="--", color=color_proposed)
...
axs[1][2].plot(vehicle_df["v_Vel"], vehicle_df["v_Accel"], alpha=0.75, color=color_before)#, label="Before Reconstruction", alpha=0.75)
axs[1][2].plot(vehicle_df_CvxOpt["v_Vel"], vehicle_df_CvxOpt["v_Accel"], linestyle="--", color=color_proposed)#, label="Proposed Reconstruction", linestyle="--")
axs[1][2].plot(vehicle_df_PIButterworth["v_Vel"], vehicle_df_PIButterworth["v_Accel"], linestyle="-.", alpha=0.75, color=color_pibutter) #, label="PI-Butterworth Reconstruction", linestyle="-.", alpha=0.75)
# axs[1][2].scatter(vehicle_df["v_Vel"], vehicle_df["v_Accel"], color=color_before, s=10, alpha=0.5)#, label="Before Reconstruction", alpha=0.75)
# axs[1][2].scatter(vehicle_df_CvxOpt["v_Vel"], vehicle_df_CvxOpt["v_Accel"], linestyle="--", color=color_proposed, s=10, alpha=0.5)#, label="Proposed Reconstruction", linestyle="--")
# axs[1][2].scatter(vehicle_df_PIButterworth["v_Vel"], vehicle_df_PIButterworth["v_Accel"], linestyle="-.",  color=color_pibutter, s=10, alpha=0.5) #, label="PI-Butterworth Reconstruction", linestyle="-.", alpha=0.75)
