...
saveAnnotations("../data_trajectories/2_frame_processed/"+RELEVANT_VIDEO+".txt", processed_annotations)
saveAnnotations("../data_trajectories/2_frame_processed/"+RELEVANT_VIDEO+"_PIX.txt", processed_annotations_pix)
...
processed_annotations = loadAnnotations("../data_trajectories/2_frame_processed/"+RELEVANT_VIDEO+".txt")
trajectorized_annotations = generateTrajectories(processed_annotations, print_status=True)
saveAnnotations("../data_trajectories/3_A_trajectorized_unlabelled/"+RELEVANT_VIDEO+".txt", trajectorized_annotations)

unique_trajectory_labels = determineUniqueTrajectoryLabels(trajectorized_annotations)

map_file = "../data_trajectories/3_B_trajectorized_mapping/"+RELEVANT_VIDEO+".txt"
...
annotation_file = "../data_trajectories/3_C_vehiclized/"+RELEVANT_VIDEO+".txt"
target_output_file = "../data_trajectories/4_kalman_filtered/"+RELEVANT_VIDEO.replace(".MOV", "")+"/"
...
video_trajectory_path = "../data_trajectories/4_kalman_filtered/"+RELEVANT_VIDEO.replace(".MOV", "")+"/"
vehiclized_file_path = "../data_trajectories/3_C_vehiclized/"+RELEVANT_VIDEO+".txt"
vehicle_proceeding_order_file_path = "../data_trajectories/5_vehicle_information/proceeding_order/"+RELEVANT_VIDEO+".txt"
trajectory_type = "obb"
target_output_file = "../data_trajectories/6_final_trajectories/"+RELEVANT_VIDEO+".txt"
...
# df_filtered_hbb = pd.read_csv("../data_trajectories/4_kalman_filtered/"+RELEVANT_VIDEO+"_"+selected_vehicle+"_hbb"+".csv")
# df_filtered_obb = pd.read_csv("../data_trajectories/4_kalman_filtered/"+RELEVANT_VIDEO+"_"+selected_vehicle+"_obb"+".csv")
...
vehicle_trajectory_final_path = "../data_trajectories/6_final_trajectories/"
vehicle_dynamics_path = "../data_trajectories/5_vehicle_information/vehicle_dynamics/"
vehicle_trajectory_reconstructed_path = "../data_trajectories/7_final_trajectories_reconstructed/"
...
# df_final_traj = df_final_traj[df_final_traj["Frame_ID"]<=6540] # FOR VIDEO 'DJI_0940.MOV'
...
storeRelaxVars(worst_case_relax_1, worst_case_relax_2, vehicle_trajectory_reconstructed_path + RELEVANT_VIDEO + "_wc.txt")
"""