...
## Publications:
```
Consistent Vehicle Trajectory Extraction From Aerial Recordings Using Oriented Object Detection. Riehl, K. and El-Baklish, S.K. and Kouvelas, T. and Makridis, M. 2025. (Submitted in Scientific Reports).
```

```
Aerial Video & Trajectory Dataset Of Vehicles On Circular Road. Riehl, K. and El-Baklish, S.K. and Kouvelas, T. and Makridis, M. 2025. (Submitted in Data in Briefs).
```
